...
# 
# Solutions to the advection-dispersion equation are obtained by:
# 
# 1. Analysis (calculus)
# 2. Numerical models (computer programs like MODPATH, MOC3D, and many more - these are left for CE 5364)
